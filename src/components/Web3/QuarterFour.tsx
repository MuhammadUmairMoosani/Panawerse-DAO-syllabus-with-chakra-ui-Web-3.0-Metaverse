            ...
            <AccordionPanel>
                ...
                <Box bg="white" p="5" borderRadius="5">
                    ...
                    <OrderedList ml="5">
                        ...
                        <Text lineHeight="2">Transfer 75% of the Tokens to the Crowd Sale contract at deployment time. i.e. Right after the contract is deployed, we want the token contract to send 75% of our token supply to it. While 25% remain in our personal "owner" account.</Text>
