            ...
            <AccordionPanel>
                ...
                <Box bg="white" p="5" borderRadius="5">
                    ...
                    <OrderedList ml="5">
                        ...
                        <Text lineHeight="2">Open Metaverse Learning Repo  <NextLink passHref href="https://github.com/panaverse/metaverse-web" target="_blank">
                        ...
                        <Text lineHeight="2">Blender 3.3+ Download  <NextLink passHref href="https://www.blender.org/download/" target="_blank">
                            <ExternalLinkIcon mx='2px' color="blue.500" />
                        </NextLink>
                        </Text>
                        <Text lineHeight="2">Blender 3.0 Beginner Tutorial   <NextLink passHref href="https://www.youtube.com/playlist?list=PLjEaoINr3zgFX8ZsChQVQsuDSjEqdWMAD" target="_blank">
                            <ExternalLinkIcon mx='2px' color="blue.500" />
                        </NextLink>
                        </Text>
                        <Text lineHeight="2">Blender 3.0 Hotkey    <NextLink passHref href="https://docs.google.com/document/d/1zPBgZAdftWa6WVa7UIFUqW_7EcqOYE0X743RqFuJL3o/edit" target="_blank">
                            <ExternalLinkIcon mx='2px' color="blue.500" />
                        </NextLink>
                        </Text>
                        <Text lineHeight="2">Blender Projects Textbook: Blender by Example 2nd Edition    <NextLink passHref href="https://www.packtpub.com/product/blender-3d-by-example-second-edition/9781789612561" target="_blank">
                            <ExternalLinkIcon mx='2px' color="blue.500" />
                        </NextLink>
                        </Text>
                        <Text lineHeight="2">Blender Textbook: The Complete Guide to Blender Graphics: Computer Modeling & Animation 7th Edition by John M. Blain
                        ...
                        <Text lineHeight="2">Best Hardware Performance for Blender Rendering
                            <NextLink passHref href="https://www.youtube.com/watch?v=H7T0SzdFHwg" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text lineHeight="2" fontWeight="bold">Assignment 1:</Text>
                        <Text lineHeight="2">Build a 3D Donut using Blender 3 as shown in these video tutorials
                            <NextLink passHref href="https://www.youtube.com/playlist?list=PLjEaoINr3zgFX8ZsChQVQsuDSjEqdWMAD" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text lineHeight="2" fontWeight="bold">Assignment 2:</Text>
                        <Text lineHeight="2">Build a Viking Scene using Blender 3 as shown in chapter 2 of the Book [Blender by Example 2nd Edition
                            <NextLink passHref href="https://www.packtpub.com/product/blender-3d-by-example-second-edition/9781789612561" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text lineHeight="2" fontWeight="bold">Assignment 3:</Text>
                        <Text lineHeight="2">Modeling a Time Machine using Blender 3 as shown in chapters 3 and 4 of the Book Blender by Example 2nd Edition
                            <NextLink passHref href="https://www.packtpub.com/product/blender-3d-by-example-second-edition/9781789612561" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text lineHeight="2" fontWeight="bold">Assignment 4:</Text>
                        <Text lineHeight="2">Modeling a Time Machine using Blender 3 as shown in chapters 3 and 4 of the Book Blender by Example 2nd Edition
                            <NextLink passHref href="https://www.packtpub.com/product/blender-3d-by-example-second-edition/9781789612561" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text lineHeight="2" fontWeight="bold">Assignment 5:</Text>
                        <Text lineHeight="2">Illustrating an Alien Hero with Grease Pencil as shown in chapter 8 of the Book Blender by Example 2nd Edition
                            <NextLink passHref href="https://www.packtpub.com/product/blender-3d-by-example-second-edition/9781789612561" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text lineHeight="2" fontWeight="bold">Assignment 6:</Text>
                        <Text lineHeight="2">Build a 3D Sword in the Stone using Blender 3 as shown in these video tutorials
