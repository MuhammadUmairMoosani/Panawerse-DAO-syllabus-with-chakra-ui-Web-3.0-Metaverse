            ...
            <AccordionPanel>
                ...
                <Box bg="white" p="5" borderRadius="5">
                    ...
                    <OrderedList ml="5">
                        ...
                        <Text>Learn HTML by Hira Khan (Watch Recorded Videos) <NextLink passHref href="https://www.youtube.com/playlist?list=PLKvqnz8z1zWQ3BALy86tIXICkG874wAc6" target="_blank"><ExternalLinkIcon mx='2px' color="blue.500" /></NextLink></Text>
                        ...
                        <Text color="green.400">Assignment</Text>
                        ...
                        <Text>3D E-commerce</Text>
                        <Text>First, in our Web 3 and Metaverse program, we are learning to develop Web 1, and Web 2 websites and apps. Later we will learn to develop Web 3 and 3D Commerce templates and experiences. </Text>
                        <Text>But we have to start thinking right now. Let's understand what one virtual store builder company is doing the company name is Emperia.
                            <NextLink passHref href="https://emperiavr.com/" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text>“Using technology, Emperia aims to make virtual worlds into the future of e-commerce, expanding the reach to new and future online shoppers, increasing brand loyalty, and creating a completely new shopping experience.”</Text>
                        <Text>Emporia just got funded
                            <NextLink passHref href="https://www.retail-insight-network.com/news/emperia-10m-growth/" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text>Checkout the Virtual Store Demos
                        ...
                        <Text>Getting Started Exercises with TypeScript and Node.js
                        ...
                        <Text color="green.400">Quiz</Text>
                        <Text>Fundamentals of JavaScript and Node.js Quiz</Text>
                        <Text fontWeight="bold" mt="2" mb="2">Topics Covered in the Quiz:</Text>
                        <OrderedList type="A">
                        ...
                        <Text>Fundamentals of TypeScript Quiz</Text>
                        <Text>TypeScript Professional Proficiency Quiz</Text>
                        ...
                        <Text color="green.400">Assignment and Quiz</Text>
                        <Text>Quarter Break Assignments and Quizzes </Text>
                        <Text fontWeight="bold">During the Quarter Break, we do the following Assignments: </Text>
                        <OrderedList ml="8">
                            ...
                            <Text>The best-developed Website will be hosted on
                            ...
                            <Text>The best-developed Website will be hosted on
                                ...
                                domain.</Text>
                            <Text>After completing the above Five Assignments everyone will appear in the following two Quizzes covering Github and TypeScript:</Text>
                        </OrderedList>
                        <Text color="green.400">Quiz</Text>
                    ...
                    <OrderedList>
                        ...
                        <Text color="green.400">Quiz</Text>
                        <Text>Git Quiz</Text>
                        <Text>Total Questions: 60, Duration: 75 minutes</Text>
                        <ListItem fontWeight="bold" mt="2">TypeScript Proficiency Quiz</ListItem>
                        <Text>Total Questions: 63, Duration: 120 minutes
                        </Text>
                        <Text>Study Material:
                            <NextLink passHref href="https://github.com/panaverse/learn-typescript" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
