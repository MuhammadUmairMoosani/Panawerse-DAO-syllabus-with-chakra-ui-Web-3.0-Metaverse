            ...
            <AccordionPanel>
                ...
                <Box bg="white" p="5" borderRadius="5">
                    ...
                    <OrderedList ml="5">
                        ...
                        <Text>Next 13 Official Documentation <NextLink passHref href="https://beta.nextjs.org/docs" target="_blank"><ExternalLinkIcon mx='2px' color="blue.500" /></NextLink></Text>
                        ...
                        <Text fontWeight="bold" mt="2">First Project for Quarter 2 Students: Build a Resume Website and Deploy it on a Custom Domain</Text>
                        <Text mt="2">All Quarter 2 students are required to Build their resume/CV website using Next.js 13 and Tailwind CSS</Text>
                        <Text>Watch this video to learn
                            <NextLink passHref href="https://morioh.com/p/45a246d927c9" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text>Once you have built your resume website, buy a domain if you can afford it and host your resume website on a custom domain
                            <NextLink passHref href="https://www.godaddy.com/en-pk" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text>Add your custom domain to your Vercel Project
                        ...
                        <Text>However, if you cannot afford it find a way to get it for free
                            <NextLink passHref href="https://www.forbes.com/advisor/business/free-domain-name/" target="_blank">
                                <ExternalLinkIcon mx='2px' color="blue.500" />
                            </NextLink>
                        </Text>
                        <Text>You will get your website graded by a faculty member in class and receive a Report Card which you will always bring to class.
                        </Text>
